...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        Shader batmanShader = new BitmapShader(BitmapFactory.decodeResource(getResources(), R.drawable.batman),
                Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Shader logoShader = new BitmapShader(BitmapFactory.decodeResource(getResources(), R.drawable.batman_logo),
                Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Shader shader = new ComposeShader(logoShader, batmanShader, PorterDuff.Mode.SRC_IN);
